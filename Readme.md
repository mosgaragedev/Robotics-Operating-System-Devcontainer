...
[![CI](https://github.com/mosgaragedev/ROS-Devcontainer/actions/workflows/ci.yaml/badge.svg)](https://github.com/mosgaragedev/ROS-Devcontainer/actions/workflows/ci.yaml) [![CD](https://github.com/mosgaragedev/ROS-Devcontainer/actions/workflows/release.yaml/badge.svg)](https://github.com/mosgaragedev/ROS-Devcontainer/actions/workflows/release.yaml)
...
- **Using CLI**:
    ```sh
    gh repo create ros2_ws --template mosgaragedev/ ROS-Devcontainer --private --clone
    ```
